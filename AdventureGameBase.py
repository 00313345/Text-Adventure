...
while response not in playerchoice:
  ...
  if response == "1":
      ...
      print("- CHALMERS: Smoke? From the oven? Is that fire in there?")
      ...
      print("- CHALMERS: Seymour, you were endangering my life!")
...
while response not in playerchoice:
  ...
  if response == "1":
      ...
      print("- SEYMOUR: Uh, Utica.")
      print("- CHALMERS: Really? Well I'm from Utica and I've Nev-")
      print("- CHALMERS: Say, I've never known you were from Utica, that's where I grew up!")
      print("Out of all the places you said, it just had to be where he originated from, how inconvenient.")
      input("\nENTER TO CONTINUE...\n")
      print("- SEYMOUR: Oh, Really?")
      print("- CHALMERS: Seems kind of strange to think over the years we've been working together and I never knew.")
      print("- CHALMERS: Huh, when you think about, we never talk outside of work, I don't really know much about you Seymour.")
      print("- SEYMOUR: Oh, ho, theres not too much about me, what have you been up to since leaving our hometown, er... Utica?")
      print("Chalmers tells you a long story about becoming the superintendent, and a large chapter of his university life.")
      input("\nENTER TO CONTINUE...\n")
...
print("- SEYMOUR: No.")
input("\nENTER TO CONTINUE...\n")
print("The two of you make your way to the front porch, everything is almost wrapped up before you remember about mother.")
print("- MRS. SKINNER: Seymour! The house is on fire!")
print("She had been upstairs looking at her photos the whole time, she's in danger of being smoked out!")
...
while response not in playerchoice:
  response = input("CHOICE: ")
  if response == "1":
      print("\nYou most certainly heroically yell out")
